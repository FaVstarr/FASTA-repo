  ...
  const TabNavigation = ({route}) =>{
    ...
    return (
      <Tab.Navigator initialRouteName='Home' screenOptions={{headerShown: false}} labeled>
        ...
        <Tab.Screen name='Profile' component={Profile} options={{ tabBarIcon:({}) =>(<FontAwesome5 name="user-circle" size={24} color="#0560FA" />) }} initialParams={{firstName: firstName, lastName: lastName}} />
      </Tab.Navigator>
    )
  }
